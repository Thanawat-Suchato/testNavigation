...
class Plain2ViewController: UIViewController {
  
  @IBOutlet weak var todoTextField: UITextField!
  @IBOutlet weak var tableView: UITableView!
  
  private static let showDetailIdentifier = "ShowDetailFromPlain2Id"
  ...
  override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    if segue.identifier == Plain2ViewController.showDetailIdentifier,
...
extension Plain2ViewController: UITableViewDataSource {
...
extension Plain2ViewController: UITableViewDelegate {
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    tableView.deselectRow(at: indexPath, animated: true)
    
    self.performSegue(withIdentifier: Plain2ViewController.showDetailIdentifier, sender: indexPath.item)
  }
}

extension Plain2ViewController: TodoItemTableViewCellDelegate {
...
extension Plain2ViewController: DetailViewDelegate {
